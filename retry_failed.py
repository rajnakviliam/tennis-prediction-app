...
def main():
    ...
    for _, p in failed.iterrows():
        ...
        html = update.download_player_page(
            player_code,
            player_name,
            retries=5,
            wait_seconds=6,
        ...
        rows = update.parse_player_matches(
            player_name,
            html,
        )
    ...
    if all_rows:
        ...
        # Nové raw riadky sú na konci, preto keep="last"
        # nahradí staré riadky bez raw štatistík.
    ...
    if still_failed:
        ...
        print(
            "Všetci zlyhaní hráči boli úspešne doplnení."
        )
