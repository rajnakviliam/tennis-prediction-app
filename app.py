...
with right:
    if run:
        ...
        with st.form("my_prediction_form"):
            ...
            with c1:
                my_p1_aces = st.text_input(f"{p1_short} esá", value="", key="my_p1_aces")
            with c2:
                my_p1_df = st.text_input(f"{p1_short} DF", value="", key="my_p1_df")
            with c3:
                my_p2_aces = st.text_input(f"{p2_short} esá", value="", key="my_p2_aces")
            with c4:
                my_p2_df = st.text_input(f"{p2_short} DF", value="", key="my_p2_df")
